 ...
 * @Date: 2026-08-14 17:31:40
 * @LastEditors: 汪培良 rick_wang@yunquna.com
 * @LastEditTime: 2026-08-14 21:13:56
 * @FilePath: /go-agent-claw/cmd/bench/main.go
...
import (
    ...
    "github.com/dk264874293/go-agent-claw/internal/eval"
...
func main() {
    ...
    // 构建一套微型评测集
    testcases := []observability.TestCase{
        {
            ID:   "test_001_edit",
            Name: "测试模糊替换工具的准确性",
            ...
            // 考题：要求修改版本号
            TaskPrompt: `当前目录下有一个 config.json。请你使用 edit_file 工具，将其中的 version 从 v1.0.0 改为 v2.0.0。不要做其他多余clear操作。`,
    ...
    runner := observability.NewBenchmarkRunner("glm-4.7")
